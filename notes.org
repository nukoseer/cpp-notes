...
*** Delegating Constructor
 Classes can have multiple ~constructors~ with a common code. In such cases, a ~delegated constructor~ can be used to gather the common code into a single ~constructor~.
 ...
 #+BEGIN_SRC C++
   ...
   public:
       ...
       // This is delegating constructor. This constructor will get called when other 2 constructor is called. It can also be called directly.
       C1(int, int, int)
       {
 ...
 #+BEGIN_SRC C++
   ...
   {
   public:
       C1(int x) : C1(x, 0, 0), mx{ 10 } {} // This is syntax error. If delegating constructor is called, constructor initializer list cannot be used for initializing non-static data members.
       C1(const char* p) : C1(std::atoi(p), 0, 0) {}

       // This is delegating constructor. This constructor will get called when other 2 constructors are called. It can also be called directly.
       C1(int, int, int)
       {
 ...
 #+BEGIN_SRC C++
   ...
   {
   public:
       // This constructor calls a delagating constructor.
       C1(int x) : C1(x, 0) {}

       // This constructor is a delagating constructor and also calls the other delagating constructor.
       C1(int x, int y) : C1(x, y, 0) {}

       // This is also a delegating constructor.
