...
*** Constructor and destructor of classes
 The ~constructor~ and ~destructor~ are in the category of ~member functions~ of classes. The instantiation of a class object is performed by the ~constructor~ of the class, while the end of life of the object is performed by the ~destructor~ of the class.
